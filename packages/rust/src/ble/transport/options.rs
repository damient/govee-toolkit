...
pub struct Options {
    ...
    /// How long each step of the handshake that opens an encoded link waits
    /// for the device's answer. See `docs/protocol/ble.md` 9.
    ...
    /// How long the send path waits between two frames of one chunked command.
    /// It costs a single-frame command nothing. `docs/protocol/ble.md` 4.
